...
def getScriptFunctions():
	return {
		'Test Script Short': 'TestScriptShort',
		'Test Script Long': 'TestScriptLong',
	}

def TestScriptShort(config):
	seq = []
	seqTime = 0
